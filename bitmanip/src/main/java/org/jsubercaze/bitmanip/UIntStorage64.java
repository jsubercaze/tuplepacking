 ...
 *
 */
public class UIntStorage64 extends AbstractBitStorage implements BitStorageI {
	/**
	 ...
	 */
	public UIntStorage64(int... params) {
		int sum = 0;
	...
	private void checkbounds(int index, long value) {
		...
		if (value >= bounds[index] || value < 0) {
			throw new IllegalArgumentException(
					"Value is out of bound " + value + " ; valid interval: [0;" + (bounds[index] - 1) + "]");
		}
